...
class SiteBackupDestinations extends Page
{
    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedServerStack;

    protected static ?string $navigationLabel = 'Destinations de sauvegarde du site';

    protected static ?string $title = 'Destinations de sauvegarde du site';

    protected static ?int $navigationSort = 91;

    protected static string|UnitEnum|null $navigationGroup = 'Administration';

    protected string $view = 'filament.pages.site-backup-destinations';
    ...
    {
        return BackupDestination::query()->whereNull('user_id')->orderBy('label')->get();
    }
    ...
    {
        $destination = BackupDestination::query()->whereNull('user_id')->findOrFail($destinationId);
    ...
    public function save(): void
    {
        ...
        if ($this->editingDestinationId) {
            $destination = BackupDestination::query()->whereNull('user_id')->findOrFail($this->editingDestinationId);
            Gate::authorize('update', $destination);
