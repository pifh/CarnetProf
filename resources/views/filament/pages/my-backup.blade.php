<x-filament-panels::page>
    <x-filament::section>
        <div class="flex flex-wrap items-center justify-between gap-4">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                Sauvegardez vos propres données (classes, élèves, notes, photos...) vers un stockage distant de votre choix.
                Aucune donnée des autres enseignants n'est incluse.
            </p>
    ...
    <x-filament::section class="mt-6">
        <div class="flex items-center justify-between gap-4">
            <x-slot name="heading">Mes destinations</x-slot>
                ...
                <div class="mt-4 flex flex-wrap items-end gap-4">
                    ...
                    @elseif ($provider === 'webdav')
                        <div>
                            ...
                            <x-filament::input.wrapper class="max-w-sm">
                                <x-filament::input type="text" wire:model="credentials.base_uri" placeholder="https://cloud.exemple.fr/remote.php/dav/files/moi/" />
                            </x-filament::input.wrapper>
